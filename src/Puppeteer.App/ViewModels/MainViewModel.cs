...
public sealed partial class MainViewModel:ObservableObject
{
 ...
 public MainViewModel(IProjectRepository repository,IProjectBackupService backup,IProjectScanner scanner,ProjectSearchService searchService,ITerminalService terminalService,IProjectLauncher launcher,IIconDiscoveryService icons,IFilePicker picker,IProjectClassifier classifier,IDocMatcher docMatcher,IDocFieldGenerator fieldGenerator,AppConfig config,IGitMetadataService git,IStartupService startup,IProjectDocVault vault)
 {
  _repository=repository;_backup=backup;_scanner=scanner;_searchService=searchService;_terminalService=terminalService;_launcher=launcher;_icons=icons;_picker=picker;_classifier=classifier;_docMatcher=docMatcher;_fieldGenerator=fieldGenerator;_config=config;_git=git;_startup=startup;_vault=vault;InitializeDocs();InitializeFieldEditor();InitializeDialog();
