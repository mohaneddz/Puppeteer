...
public static class ServiceCollectionExtensions
{
    public static IServiceCollection AddPuppeteerInfrastructure(this IServiceCollection services, string databasePath) => services
        ...
        .AddKeyedSingleton<IDocFieldGenerator, GroqDocFieldGenerator>("groq", (_, _) => new GroqDocFieldGenerator(new System.Net.Http.HttpClient { Timeout = TimeSpan.FromSeconds(30) }))
        .AddKeyedSingleton<IDocFieldGenerator, ClaudeCodeDocFieldGenerator>("claude")
